        ...
        <div className="space-y-8">
          ...
          <div>
            ...
            <ul className="mt-3">
              ...
              >
                <Link
                    to="/menu-docentes/contenido-audiovisual"
                    className={`block text-slate-200 truncate transition duration-150 ${
              ...
              */}
              ...
              >
                <Link
                  to="/menu-docentes/mis-proyectos"
                  className={`block text-slate-200 truncate transition duration-150 ${
              ...
              >
                <NavLink
                  ...
                  to="/menu-docentes/mi-plan-trabajo"
                  className={`block text-slate-200 truncate transition duration-150 ${
